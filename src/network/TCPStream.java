...
public class TCPStream extends Thread{
    ...
    private TCPCreatedListener listener = null;
    ...
    public TCPStream(int port, boolean asServer, String name, TCPCreatedListener listener){
        this(port,asServer,name);
    ...
    public void setStreamCreationListener(TCPCreatedListener listener) {
        this.listener = listener;
    }
